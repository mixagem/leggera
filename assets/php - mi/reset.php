...
// verifica se o user email introduzidos existem
...
if (mysqli_num_rows($result) == 1) {
    ...
    // atualiza o registo do user com o token. Em adição, limpa a cookie existente.
    $query = "UPDATE users SET unlocktoken = '$token', cookie = '' WHERE (email = '$usermail' AND username = '$un');";
    $result = mysqli_query($con, $query);
    if (mysqli_affected_rows($con) == 1) {
        ...
        echo 'Erro: Ocorreu um erro ao gerar um token de recuperação.';
    }
} else {
