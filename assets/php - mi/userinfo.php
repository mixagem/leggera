...
switch ($action) {
    case 'userstats':
        ...
        $ticksM = ceil(($ticks * 10 / 60) % 60);
        if ($ticksM < 10) { $ticksM = '0' . strval($ticksM); };

        $ticksH = floor($ticks * 10 / 60 / 60);
        if ($ticksH < 10) { $ticksH = '0' . strval($ticksH); };
        ...
        <div style='padding-top:20px;' class='row'>
            ...
            <div id='user-info-wrapper' class='col-sm-8'>
                ...
                <div id='user-stats' style='display: flex;text-align: center; padding-top: 2%;font-size: 20px;'>
                    ...
                    <div style='width:30%;'>Número de manuais<br>
                        <div style='padding:5px;;width:100%;font-size:30px;font-weight: bold;'>" . $totalmanuals . "</div>
                    </div>
                    <div style='width:35%;'>Tempo em manuais<br>
                        <div style='padding:5px;;width:100%;font-size:30px;font-weight: bold;'>" . $ticksH . ":" . $ticksM . "</div>
                    </div>
                </div>
            </div>";
        $jsonarray[] =  $alertas;
