<?php 
echo "<div class='container-fluid'><div class='row app-grid'>
<div class='col-md-5 app-nav'>
            ...
            <div class='row'>
                ...
                <div class='col-sm-12'>
                    ...
                    <div class='col-sm-7 headControls text-right'>
                        <button type='button' class='btn btn-warning no-display' id='preview-btn'><i
                                class='lni lni-magnifier'></i>
                            Prever</button>
                        <button type='button' class='btn btn-warning' id='quicksave-btn'><i
                                class='lni lni-upload'></i>
                            Quicksave</button>
                        <button type='button' class='btn btn-warning' id='quickload-btn'><i
                                class='lni lni-download'></i>
                            Quickload</button>
                        <button type='button' class='btn btn-warning' id='userstats-btn'><i
                                class='lni lni-user'></i>
                        </button>
                        <button type='button' class='btn btn-danger' id='logout-btn'><i
                                class='lni lni-power-switch'></i>
                        </button>
                    </div>
                    ...
                    <section class='header-hc'>
                        <div class='container-fluid'>
                            <div class='row'>
                                ...
                                <div class='col-sm-4 head-slogan'><span>fast software</span> for fast companies
                                </div>
                            </div>
                        </div>
                    </section>
