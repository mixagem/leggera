...
if (mysqli_num_rows($result) == 1) {
    ...
    $query2 = "UPDATE users SET unlocktoken = '$token', cookie = '' WHERE (email = '$usermail' AND username = '$un');";
    ...
    if (mysqli_affected_rows($con2) == 1) {
        ...
        <div style='display:flex;justify-content:center;align-self:center;padding:20px 0px;'>
            <span
                style='border:1px solid black;padding:5px 20px;font-size:20px;color:rgb(56,92,255);font-weight:bold;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;border-radius: 5px;'>" . $token . "</span>
        </div>
